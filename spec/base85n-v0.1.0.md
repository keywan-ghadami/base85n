...
The security-relevant surface of this specification is the *decoder*, because a
decoder is by nature fed data that the receiving system did not produce. The
following properties are therefore normative for implementations:
